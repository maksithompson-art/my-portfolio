...
export default function VisualExpertise({ dict, lang }: { dict: VisualExpertiseDict; lang: string }) {
  return (
    <section className="relative w-full bg-[#0A0A0A] text-white py-16 md:py-32 px-8 md:px-12 lg:px-24 flex flex-col items-center border-t border-white/5">

      {/* MASSIVE TYPOGRAPHY GRAPHIC */}
      <div className="w-full flex items-center justify-center mb-12 md:mb-24 cursor-default">
        <h2 className="text-[2.25rem] md:text-[8rem] lg:text-[13rem] font-black tracking-tighter text-transparent [-webkit-text-stroke:2px_#CCFF00] leading-none flex items-center hover:text-[#CCFF00] transition-colors duration-700">
          3D
          <div className="mx-2 md:mx-8 w-8 md:w-32 aspect-square rounded-full border-[3px] md:border-[8px] border-white flex items-center justify-center hover:scale-110 transition-transform duration-500 shadow-[0_0_30px_rgba(204,255,0,0.2)]">
      ...
      {/* SUB-HEADER */}
      <div className="w-full max-w-6xl flex flex-col items-center justify-center mb-10 md:mb-16 gap-4 text-center">
